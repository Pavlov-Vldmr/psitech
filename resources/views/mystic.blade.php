...
@endsection
@section('content')
    <meta name="description" content="Мистик — это средство самопознания, легкий способ поверить в себя.">
    <div id="mysticGame" class="mystic-container game-container section">
        <h1 class="about_game_article text-center p-4 text-white" style="font: 80px 'CaveatBold">MYSTIC perfomance</h1>
        <div class="container">
            <div class="row featurette">
                ...
                <div class="d-flex mx-auto">
                    <img src="/img/mystic/Mysic.webp"
                         class="top_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                         alt="">
                </div>
            </div>
            <div class="game-btn-block d-flex align-center">
                <!-- <a id="" class="about-game-btn user-btn " href="">подробнее</a> -->
                <a id="MysticBuy" class="buy-game-btn user-btn buy_btn" href="#">{{__('home.buy')}}</a>
    ...
    <div class="py-3 mb-2 short_about_game d-flex align-items-center justify-content-center">
        <div class="container d-flex wrap justify-content-around align-items-center">
            <div class="d-flex align-items-center justify-content-center  element-animation">
                ...
                <p class="px-3">{{__('mystic.short_about_1_1')}}</p>
            </div>
            <div class="d-flex align-items-center justify-content-center">
{{--                <img src="/icons/group.png"--}}
{{--                    class="mx-2 rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "--}}
{{--                     width="50" height="50" alt="">--}}
                <p class="px-3  element-animation">{{__('mystic.short_about_1_2')}}</p>
            </div>
        </div>
    </div>
    ...
    <!-- IMAGE !LEGT -->
    <div class="mt-5 about_game_container section">
        <div class="container">
            <div class="row featurette">
                <div class="d-flex flex-column align-items-center col-md-7 order-md-2">
                    <p class="pt-3  fs-3 text-center  element-animation">{{__('mystic.article_title_1')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class="game_discription article-game text-center  element-animation">{{__('mystic.article_1')}}</p>
                </div>
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
                <div class="col-md-5 d-flex mx-auto  element-animation">
                    <img src="/img/mystic/cards/card (5).jpg"
                         class="aside_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row featurette">
                <div class="d-flex flex-column align-items-center col-md-7">
                    <p class="pt-3  fs-3 text-center  element-animation">{{__('mystic.article_title_2')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class=" game_discription article-game text-center element-animation">{{__('mystic.article_2')}}</p>
                </div>
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
                <div class="col-md-5 d-flex mx-auto element-animation">
                    <img src="/img/mystic/cards/card (8).jpg"
                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image  mx-auto" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="about_game_container section">
        <div class="container">
            <div class="row featurette">
                <div class=" d-flex flex-column align-items-center col-md-7 order-md-2">
                    <p class="pt-3  fs-3 text-center element-animation">{{__('mystic.article_title_3')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class="game_discription article-game text-center element-animation">{{__('mystic.article_3')}}</p>
                </div>
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
                <div class="col-md-5 d-flex mx-auto element-animation">
                    <img src="/img/mystic/cards/card (1).jpg"
                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
...
{{--            <div class="row featurette">--}}
{{--                <div class="d-flex flex-column align-items-center col-md-7">--}}
{{--                    <p class="pt-3 fs-3 text-center">{{__('mystic.article_title_4')}}</p>--}}
{{--                    <hr class="bg-secondary" style="width: 300px; height: 2px">--}}
{{--                    <p class=" game_discription article-game text-center">{{__('mystic.article_4')}} </p>--}}
{{--                </div>--}}
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
{{--                <div class="col-md-5 d-flex mx-auto">--}}
{{--                    <img src="/img/mystic/cards/card (4).jpg"--}}
{{--                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image  mx-auto" alt="" style="max-width: 300px">--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--            <div class="row featurette">--}}
{{--                <div class=" d-flex flex-column align-items-center col-md-7 order-md-2">--}}
{{--                    <p class="pt-3 fs-3 text-center">{{__('mystic.article_title_5')}}</p>--}}
{{--                    <hr class="bg-secondary" style="width: 300px; height: 2px">--}}
{{--                    <p class="game_discription article-game text-center">{{__('mystic.article_5')}}</p>--}}
{{--                </div>--}}
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
{{--                <div class="col-md-5 d-flex mx-auto">--}}
{{--                    <img src="/img/mystic/cards/card (2).jpg"--}}
{{--                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto" alt="" style="max-width: 300px">--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--            <div class="row featurette">--}}
{{--                <div class="d-flex flex-column align-items-center col-md-7">--}}
{{--                    <p class="pt-3 fs-3 text-center">{{__('mystic.article_title_6')}}</p>--}}
{{--                    <hr class="bg-secondary" style="width: 300px; height: 2px">--}}
{{--                    <p class=" game_discription article-game text-center">{{__('mystic.article_6')}}</p>--}}
{{--                </div>--}}
{{--                <div class="col-md-5 order-md-1 d-flex mx-auto">--}}
{{--                <div class="col-md-5 d-flex mx-auto">--}}
{{--                    <img src="/img/mystic/cards/card (6).jpg"--}}
{{--                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image  mx-auto" alt="" style="max-width: 300px">--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
    ...
    <div class="about_game_container section">
        <div class="container mb-5">
            <div class="row featurette">
                <div class=" d-flex flex-column align-items-center col-md-7">
                    <p class="pt-3 fs-3 text-center element-animation">{{__('mystic.article_title_7')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class="game_discription article-game text-center element-animation">{{__('mystic.article_7')}}</p>
                </div>
                <div class="col-md-5 order-md-1 d-flex mx-auto">
                <div class="col-md-5 d-flex mx-auto element-animation">
                    <img src="/img/mystic/cards/card (7).jpg"
                         class="aside_photo img-fluid user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
...
{{--                     class="mx-2 rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "--}}
{{--                     width="50" height="50" alt="">--}}
                <p class="px-3 element-animation">{{__('mystic.short_about_2_1')}}</p>
            </div>
{{--            <div class="d-flex align-items-center justify-content-center">--}}
{{--                <img src="/icons/group.png"--}}
{{--                     class="mx-2 rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "--}}
{{--                     width="50" height="50" alt="">--}}
{{--                <p class="px-3">От 2 до 9 участников</p>--}}
{{--            </div>--}}
        </div>
    </div>
    <!-- SHORT ABOUT GAME END-->
        ...
        <div class="ym-products">
            ...
            <div class="ym-product">
                <div class="ym-product-line">
                    <span class="ym-product-description">Игровой комплект Mystic performance</span>
                    <span class="ym-product-price" data-price="9200">9&nbsp;200,00&nbsp;₽</span>
                </div>
                ...
                <input disabled="" type="hidden" name="text" value="Игровой комплект Mystic performance"><input disabled="" type="hidden" name="price" value="9200"><input disabled="" type="hidden" name="quantity" value="1"><input disabled="" type="hidden" name="paymentSubjectType" value="commodity"><input disabled="" type="hidden" name="paymentMethodType" value="full_prepayment"><input disabled="" type="hidden" name="tax" value="1"></div></div>
