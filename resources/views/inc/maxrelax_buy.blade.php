@section('maxrelax_buy')
    <div id="myModalMaxrelax" class="MaxrelaxBuy">
        {{--        <span id="myModalMaxrelax__close" class="close"></span>--}}
        <br><link rel="stylesheet" href="https://yookassa.ru/integration/simplepay/css/yookassa_construct_form.css">
        <form class="pb-5 mx-auto bg-light yoomoney-payment-form"
            ...
            <div class="ym-products">
                ...
                <div class="ym-product">
                    ...
                    <input disabled="" type="hidden" name="text" value="Игровой комплект MaxrelaX"><input disabled=""
                                                                                                          type="hidden"
                                                                                                          name="price"
                                                                                                          value="3200"><input
                        disabled="" type="hidden" name="quantity" value="1"><input disabled="" type="hidden"
                                                                                   name="paymentSubjectType"
                                                                                   value="commodity"><input disabled=""
                                                                                                            type="hidden"
            ...
            <div class="ym-payment-btn-block ym-before-line ym-align-space-between">
                ...
                <button data-text="Заплатить" class="ym-btn-pay ym-result-price"><span
                        class="ym-text-crop">Заплатить</span> <span class="ym-price-output">3&nbsp;200,00&nbsp;₽</span>
                </button>
    ...
    <div id="myOverlayMaxrelax" class="MaxrelaxBuy"></div>
