@section('mystic_buy')
    <div id="myModalMystic" class="MysticBuy">
        {{--        <span id="myModalMystic__close" class="close"></span>--}}
        <br>
        <link rel="stylesheet" href="https://yookassa.ru/integration/simplepay/css/yookassa_construct_form.css">
        <form class="py-2 pb-5 my-3 mx-auto bg-light yoomoney-payment-form"
              action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8">
            ...
            <div class="ym-products">
                ...
                <div class="ym-product">
                    ...
                    <input disabled="" type="hidden" name="text" value="Игровой комплект Mystic performance"><input
                        disabled="" type="hidden" name="price" value="9200"><input disabled="" type="hidden"
                                                                                   name="quantity" value="1"><input
                        disabled="" type="hidden" name="paymentSubjectType" value="commodity"><input disabled=""
                                                                                                     type="hidden"
                                                                                                     name="paymentMethodType"
                                                                                                     value="full_prepayment"><input
                        disabled="" type="hidden" name="tax" value="1"></div>
            </div>
            ...
            <div class="ym-payment-btn-block ym-before-line ym-align-space-between">
                <div class="ym-input-icon-rub ym-display-none">
                    <input name="sum" placeholder="0.00" class="ym-input ym-sum-input ym-required-input" type="number"
                           step="any" value="3200">
                </div>
                <button data-text="Заплатить" class="ym-btn-pay ym-result-price"><span
                        class="ym-text-crop">Заплатить</span> <span class="ym-price-output">9&nbsp;200,00&nbsp;₽</span>
                </button>
                ...
                <lineargradient id="paint0_linear" x1="57.3564" y1="0" x2="57.3564" y2="63"
    ...
    <div id="myOverlayMystic" class="MysticBuy"></div>
