{{--54k--}}
@section('casino69deepbuy')
<div id="myModalCasinoDeep" class="CasinoDeepBuy">
{{--    <span id="myModalCasino__close" class="close"></span>--}}
    ...
    <form class="pb-5 mx-auto bg-light yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8" >
...
<div id="myOverlayCasinoDeep" class="CasinoDeepBuy"></div>
