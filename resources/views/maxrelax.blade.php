...
@section('title-content')
    PsiTech. MaxRelax
@endsection
@section('meta-keywords')maxrelax
...
@endsection
@section('content')
    <div id="mysticGame" class="maxrelax-container game-container section">
        <h1 class="about_game_article text-center p-4 text-white" style="font: 80px 'CaveatBold">MaxrelaX</h1>
        <div class="container d-flex flex-column align-items-center justify-content-center">
            <div class="row featurette">
                ...
                <div class="d-flex mx-auto">
                    <img src="/img/maxrelax/MaxRelax.webp"
                         class="top_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                          alt="">
                </div>
            </div>
            <div class="game-btn-block d-flex flex-column align-items-center justify-content-center">
                <!-- <a id="" class="about-game-btn user-btn " href="">подробнее</a> -->
                <a id="MaxrelaxBuy" class="buy-game-btn user-btn buy_btn" href="#">{{__('home.buy')}}</a>
                <a style="text-decoration: none; color: white; border-radius: 5px; letter-spacing: 1px;" target="_blank" href="https://psitech.one/data/maxrelax/MaxRelaX.pdf" class="mt-5 d-flex align-items-center justify-content-center to_bot_btn element-animation ">
                    Подробнее
                </a>
            </div>
        </div>
    ...
    <!-- SHORT ABOUT GAME-->
{{--    <a id="" class="buy-game-btn user-btn buy_btn" href="">test</a>--}}
{{--    <a class="buy-game-btn user-btn buy_btn" href="{{ url('/') }}/data/maxrelax/MaxRelax.pdf" target="_blank">--}}
    <div class="py-3 mb-2 short_about_game d-flex align-items-center justify-content-center">
        <div class="container d-flex wrap justify-content-around align-items-center">
            <div class="d-flex align-items-center justify-content-center  element-animation">
                ...
                <p class="px-3 ">{{__('maxrelax.short_about_1_1')}}</p>
            </div>
...
{{--    <div id="delivery" class="d-flex flex-column align-items-center justify-content-center section " data-percentage="80">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-01.png" alt="Slide 1">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-02.png" alt="Slide 2">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-04.png" alt="Slide 3">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-05.png" alt="Slide 4">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-06.png" alt="Slide 5">--}}
{{--        <img class="d-flex align-items-center justify-content-center mx-3 img-fluid " style="margin: 0px 10px;"     src="/img/maxrelax/img_plate/MaxRelaX-07.png" alt="Slide 6">--}}
{{--    </div>--}}

{{--    <div class="d-flex align-items-center justify-content-center mb-4">--}}
{{--        <div class="mt-5 d-flex align-items-center justify-content-center to_bot_btn element-animation ">--}}
{{--            <img src="/icons/Telegram.png"--}}
{{--                 class="rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "--}}
{{--                 width="25" height="25" alt="">--}}
{{--            <a href="https://t.me/maxRelax1_bot" class="mx-2">--}}
{{--                maxrelaxbot--}}
{{--            </a>--}}
{{--        </div>--}}
{{--    </div>--}}
    ...
    <div class="d-flex align-items-center justify-content-center mt-4">
        <video width="320" height="240" controls>
            <source src="/video/maxrelax/maxrelax_video.MOV" type="video/mp4">
    ...
    <div class="py-3 short_about_game d-flex align-items-center justify-content-center">
        <div class="container d-flex wrap justify-content-around align-items-center">
             <div class="d-flex align-items-center justify-content-center">
                 <p class="px-3 element-animation " >{{__('maxrelax.short_about_2_1')}}</p>
             </div>
        </div>
    </div>
    <!-- SHORT ABOUT GAME END-->
...
{{--                    <span class="ym-product-description">Игровой комплект MaxrelaX</span>--}}
{{--                    <span class="ym-product-price" data-price="3200">3&nbsp;200,00&nbsp;₽</span>--}}
{{--                </div>--}}
...
{{--                    </div>--}}
{{--                </div>--}}
{{--                <input disabled="" type="hidden" name="text" value="Игровой комплект MaxrelaX"><input disabled="" type="hidden" name="price" value="3200"><input disabled="" type="hidden" name="quantity" value="1"><input disabled="" type="hidden" name="paymentSubjectType" value="commodity"><input disabled="" type="hidden" name="paymentMethodType" value="full_prepayment"><input disabled="" type="hidden" name="tax" value="1"></div></div>--}}
...
{{--        <input name="customerNumber" type="hidden" value="Игровой комплект MaxrelaX">--}}
