...
@endsection
@section('content')
    <div id="mysticGame" class="casino-deep-container  game-container section">
{{--        <h2 class="col-lg-8 mx-auto about_game_article text-center p-4">{{__('casino69deep.main_title')}}</h2>--}}
        <div class="container">
            <div class="row featurette">
                ...
                <div class="d-flex mx-auto">
                    <img src="/img/casino69/cards/4 черви.jpg"
            ...
            <div class="game-btn-block d-flex align-center">
                ...
                <a id="CasinoDeepBuy" class="buy-game-btn user-btn buy_btn" href="#">{{__('home.buy')}}</a>
    ...
    <div class="py-3 mb-4 short_about_game d-flex align-items-center justify-content-center">
        <div class="container d-flex wrap justify-content-around align-items-center">
            <div class="d-flex align-items-center justify-content-center element-animation">
                ...
                <p class="px-3">{{__('casino69deep.short_about_1_1')}}</p>
            </div>
            <div class="d-flex align-items-center justify-content-center element-animation">
                <img src="/icons/group.png"
                     class="mx-2 rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "
                     width="50" height="50" alt="">
                <p class="px-3">{{__('casino69deep.short_about_1_2')}}</p>
            </div>
        </div>
    </div>
...
{{--    <h2 class="mb-4 featurette-heading text-center p-4">Трансформационная ролевая коммуникативная игра<span class="text-muted"></span></h2>--}}
        ...
        <div class="container">
            <div class="row featurette">
                <div class=" d-flex flex-column align-items-center col-md-7 order-md-2">
                    <p class="pt-3  fs-3 element-animation">{{__('casino69deep.article_title_1')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class="game_discription article-game text-center element-animation">{{__('casino69deep.article_1')}}</p>
                </div>
                <div class="col-md-5 order-md-1 d-flex mx-auto element-animation">
                    <img src="/img/casino69/cards/Туз треф.jpg"
                         class="aside_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto img-fluid" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row featurette">
                <div class="d-flex flex-column align-items-center col-md-7">
                    <p class="pt-3  fs-3 element-animation">{{__('casino69deep.article_title_2')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class=" game_discription article-game text-center element-animation">{{__('casino69deep.article_2')}}</p>
                </div>
                <div class="col-md-5 order-md-1 d-flex mx-auto element-animation">
                    <img src="/img/casino69/cards/8 черви.jpg"
                         class="aside_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto img-fluid" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
    ...
    <div class="about_game_container section">
        <div class="container">
            <div class="row featurette">
                <div class="d-flex flex-column align-items-center col-md-7 order-md-2">
                    <p class="pt-3  fs-3 element-animation">{{__('casino69deep.article_title_3')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class="game_discription article-game text-center element-animation">{{__('casino69deep.article_3')}}</p>
                </div>
                <div class="col-md-5 order-md-1 d-flex mx-auto element-animation">
                    <img src="/img/casino69/cards/Валет пики.jpg"
                         class="aside_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto img-fluid" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
    ...
    <div class="about_game_container section">
        <div class="container">
            <div class="row featurette">
                <div class="d-flex flex-column align-items-center col-md-7">
                    <p class="pt-3  fs-3 element-animation">{{__('casino69deep.article_title_4')}}</p>
                    <hr class="bg-secondary" style="width: 300px; height: 2px">
                    <p class=" game_discription article-game text-center element-animation">{{__('casino69deep.article_4')}}</p>
                </div>
                <div class="col-md-5 order-md-1 d-flex mx-auto element-animation">
                    <img src="/img/casino69/cards/10 черви.jpg"
                         class="aside_photo user_shadow rounded bd-placeholder-img bd-placeholder-img-lg featurette-image mx-auto img-fluid" alt="" style="max-width: 300px">
                </div>
            </div>
        </div>
...
{{--                     class="mx-2 rounded bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid "--}}
{{--                     width="50" height="50" alt="">--}}
                <p class="px-3 element-animation">{{__('casino69deep.short_about_2_1')}}</p>
            </div>
        </div>
    </div>
    <!-- SHORT ABOUT GAME END-->
